...
| 0x2C   | 4    | `reserved`               | Feature-specific; not described in core format |
...
| 0x54   | 2    | `compression_enable`     | 0 for non-compressed images, any non-zero value for compressed images |
| 0x56   | 4    | `reserved`               | Feature-specific; not described in core format |
| 0x5A   | 1    | `dirblkbits`             | Directory block size = `2^(blkszbits + dirblkbits)`; currently always 0 |
| 0x5B   | 17   | `reserved`               | Feature-specific; not described in core format |
...
| 0x78   | 8    | `reserved`               | Reserved; must be 0 |
...
| 0x02   | 2    | `reserved`       | Feature-specific; not described in core format |
...
| Offset | Size | Name        | Description |
|--------|------|-------------|-------------|
| 0x00   | 8    | `nid`       | Node number of the target inode |
